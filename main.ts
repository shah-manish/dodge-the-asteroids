...
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.Player, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
    Asteroid.destroy(effects.fire, 50)
    music.jumpDown.play()
})
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Enemy, function (sprite, otherSprite) {
    Asteroid.destroy(effects.spray, 100)
})
let randomizer = 0
...
forever(function () {
    ...
    if (randomizer == 1) {
        Asteroid = sprites.create(img`
            ...
            . . . . . . . . c c c c . . . . 
            `, SpriteKind.Enemy)
        Asteroid.setPosition(0, randint(0, 120))
        Asteroid.setVelocity(randint(20, 100), randint(-100, 100))
    ...
    info.changeScoreBy(Math.abs(Asteroid.vx) + Math.abs(Asteroid.vy))
})
